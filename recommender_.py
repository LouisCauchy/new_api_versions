#import os
#filename = os.path.join(os.path.dirname(os.path.realpath(__file__)), '/log/recommender.log')
import logging
logging.basicConfig(level = logging.INFO,format = '%(asctime)s %(message)s',
datefmt = '%d/%m/%Y %H:%M:%S',filename = 'log/recommender.log')
